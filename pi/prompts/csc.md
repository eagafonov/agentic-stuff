...
If parameters are provided, treat them as hints for the commit message (e.g. 'csc Prefix with Jira ticket FOOBAR-12345' should include that ticket ID in the commit subject).
